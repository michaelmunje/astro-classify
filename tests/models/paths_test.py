...
def test_default_paths():
    ...
    assert(model_paths.valid_true == os.getcwd() + "/data/kaggle/valid_true.csv")
    assert(model_paths.valid_preds == os.getcwd() + "/data/kaggle/valid_preds.csv")
...
def test_custom_paths():
    model_paths = models.initialize_custom_paths(test_images_p="asdf", train_images_p="gggg", train_sol='1234', clean_sols='pl', augmented_sols='hello',
                                                 ...
                                                 checkpoint_p_outer='aaaa/aaaa.a', checkpoint_p_overall='aaaa/aaab.a', val_true='bb', val_preds='c.c')
