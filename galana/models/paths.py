...
def initialize_custom_paths(test_images_f, test_images_p, train_images_p, train_images_f, train_sol, clean_sols,
                            test_f, output_model_f, output_model_w, checkpoint_p, val_true, val_preds):
    model_paths = ModelPaths()
    model_paths.test_image_path = test_images_p
    model_paths.test_image_files = test_images_f
    model_paths.train_image_path = train_images_p
    model_paths.train_image_files = train_images_f
